...
def show_receipt(v):
    ...
    try:
        ...
        <style>
            ...
            .token-box {{ text-align: center; border: 1px solid #000; margin: 5px 0; padding: 3px; font-size: 16px; font-weight: bold; }}
        </style>
        ...
        <div class="receipt-container">
            ...
            <table style="width: 100%; font-size: 12px;">
                ...
                <tr><td><b>Mobile:</b> {v[4]}</td><td align="right"></td></tr>
            </table>
        ...
        # Details (Tests aur Meds) ko split karke dikhane ka logic
        # Yeh aapke string "Tests: CBC | Meds: Panadol" ko handle karega
        raw_details = str(v[8]).replace("Tests: ", "").replace("Meds: ", "")
        detail_parts = raw_details.split(" | ")
        ...
        st.button("Print Slip (Ctrl+P)", key="print_slip_final")
